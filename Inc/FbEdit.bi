...
'Dim Shared hProject as HWND    '资源窗口的工程窗口句柄
'Dim Shared hProperty As HWND   '资源窗口的属性串口句柄
'Dim Shared ProjRc As RECT
'Dim Shared PropRc As RECT
...
'Dim Shared lpOldResourceProc As Any Ptr
...
Dim Shared fAddMainFiles As Long
...
Dim Shared SelFbcType As Long = 1  '0 - none(not choose the fbc),1 - windows 32bit,2 - windows 64bit
...
Dim Shared kwcol As KWCOLOR=(BGR(0,0,128),BGR(0,0,128),BGR(0,0,128),BGR(64,64,0),BGR(128,0,0),BGR(0,0,128),BGR(0,0,128),BGR(0,0,128),BGR(0,0,128),&H1000000+BGR(0,0,128),&H4000000+BGR(0,0,128),BGR(0,0,128),BGR(0,0,128),BGR(0,0,128),BGR(0,0,128),BGR(0,0,128),&H1000000+BGR(0,255,255),&H1000000+BGR(0,255,255),&H1000000+BGR(0,255,255))
